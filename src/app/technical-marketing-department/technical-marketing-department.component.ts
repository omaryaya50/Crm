...
@Component({
  selector: 'app-technical-marketing-department',
  templateUrl: './technical-marketing-department.component.html',
  styleUrls: ['./technical-marketing-department.component.css']
})
export class TechnicalMarketingDepartmentComponent implements OnInit {
