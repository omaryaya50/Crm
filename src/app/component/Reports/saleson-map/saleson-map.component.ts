...
@Component({
  selector: 'app-saleson-map',
  templateUrl: './saleson-map.component.html',
  styleUrls: ['./saleson-map.component.css']
})
export class SalesonMapComponent implements OnInit {
  CustomerView: any;
...
public  noofcusts=0;
 ...
 /*      this.obserCustomer.GetAlldata().subscribe(res => {
    ...
    this.obserCustomer.objfiltercustseles={
      CustomerID:0,
      Gid:0,
      Rid:0, 
      SalesID:0,
...
async showdata(){
  this.spinner.show();
this.obserCustomer.objfiltercustseles.CustomerID=this.CustomerID;
this.obserCustomer.objfiltercustseles.SalesID=this.SalesID;
this.obserCustomer.objfiltercustseles.Tid=this.Tid;
this.obserCustomer.objfiltercustseles.Gid=this.Gid;
this.obserCustomer.objfiltercustseles.Rid=this.Rid;
this.obserCustomer.objfiltercustseles.Sid=this.Sid;
this.obserCustomer.objfiltercustseles.fromdate=this.FromDate;
this.obserCustomer.objfiltercustseles.todate=this.ToDate;
console.log(this.obserCustomer.objfiltercustseles);
 this.obserCustomer.FindByMapSales(this.obserCustomer.objfiltercustseles).subscribe(res=>{
